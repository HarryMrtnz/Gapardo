...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-12-2022 a las 01:05:33
...
(4, 'Quemirá bobo? Andapayá!', 5, '2022-12-15', 4, 1),
...
(5, 'Dibu', 'Martí­nez', 'dibu@dv.net', 'f10e2821bbbea527ea02200352313bc059445190', 'usuario', '2022-09-15', 'activo'),
...
--
ALTER TABLE `producto_carrito`
  MODIFY `id_producto_carrito` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
